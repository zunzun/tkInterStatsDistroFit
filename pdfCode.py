...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_number(self, page_count):
        ...
        self.drawCentredString(25*mm, 20*mm, 'https://github.com/zunzun/tkInterStatsDistroFit')



def CreatePDF(inFileAndPathName, inLongName, inGraphList, inTextList):
    pageElements = []
    ...
    tableRow = ['tkInterStatsDistroFit'] # originally included images that are now unused
    ...
    pageElements.append(reportlab.platypus.Paragraph(inLongName, styles['CenteredBodyText']))
    ...
    for report in inGraphList:
        ...
        report.savefig(fname, format='png')
